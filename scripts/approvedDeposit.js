...
const ABI = require("../artifacts/contracts/travl.sol/travl.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("travl");
  const nft = await NFT.attach("0x2D2f41BfBa352C388aeAF2A74a09F5Adde11b81F");
